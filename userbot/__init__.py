...
if version_info[0] < 3 or version_info[1] < 8:
    LOGS.info(
        "Anda HARUS memiliki versi python minimal 3.8."
...
TG_BOT_TOKEN = os.environ.get("BOT_TOKEN") or None
...
UPSTREAM_REPO_URL = (os.environ.get("UPSTREAM_REPO_URL")
                     or "https://github.com/FS-Project/FeRuBoT.git")
...
# Default .alive logo
ALIVE_LOGO = os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/2ca6ebc8dc148d795d8a5.jpg"
...
# User Terminal alias
USER_TERM_ALIAS = os.environ.get("USER_TERM_ALIAS") or "FeRuBoT"
