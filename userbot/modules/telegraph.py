        ...
        if graph.reply_to_msg_id:
            ...
            if input_str == "m":
                ...
                try:
                    ...
                    os.remove(downloaded_file_name)
                    await graph.edit(
                        "Suckses mengUpload ke [telegra.ph](https://telegra.ph{}).".format(
                            media_urls[0]
                        ),
                        link_preview=True,
                    )
                ...
                await graph.edit(
                    "Sukses diupload ke [telegra.ph](https://telegra.ph/{}).".format(
                        response["path"]
                    ),
                    link_preview=True,
                )
...
CMD_HELP.update(
    {
        "telegraph": ".tg <m|t>\
        \nPenggunaan: Upload t(text) atau m(media) diTelegraph."
    }
)
