...
async def kang(args):
    ...
    if photo:
        ...
        packname = f"a{user.id}_by_FeRuBoT_{pack}"
        packnick = f"@{user.username} pack curian Vol.{pack}"
        cmd = "/newpack"
        file = io.BytesIO()
                ...
                while "120" in x.text:
                    ...
                    if x.text == "pack yang dipilih tidak valid.":
                        ...
                        await args.edit(
                            f"`____TERCURY____ !\
                            \nPack baru dibuat!\
                            \nPack kamu bisa ditemukan [dimari](t.me/addstickers/{packname})",
                            parse_mode="md",
                        )
                        return
                if is_anim:
        ...
        await args.edit(
            f"`____TERCURY____`\
            \nPack dapat dilihat [disini](t.me/addstickers/{packname})",
            parse_mode="md",
        )
