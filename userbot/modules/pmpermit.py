...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"[{name0}](tg://user?id={uid}) `Sudah diterima PM!`")
...
async def disapprovepm(disapprvpm):
    ...
    if BOTLOG:
        await disapprvpm.client.send_message(
            ...
            " Telah di batalkan izin PM ke kamu.",
        )
...
async def blockpm(block):
    ...
    if block.reply_to_msg_id:
        ...
        await block.edit("`Anda saya block!`")
        uid = replied_user.id
    else:
...
\n\n.block\
\nPenggunann: Block seseorang.\
\n\n.unblock\
\nUsage: Meng-unblock seseorang agar bisa PM anda.\
\n\n.notifoff\
...
\nUsage: Mengatur pesan khusus, akan terlihat bila seseorang PM anda sebelum di Approve\
\n\n.get pm_msg\
\nUsage: Melihat pesan khusus anda ketika di PM\
\n\n.reset pm_msg\
\nUsage: Menghapus pesan kostum anda ketika di PM\
