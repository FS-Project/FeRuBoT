...
async def paste(pstl):
    ...
    if not match and not reply_id:
        await pstl.edit("`Elon Musk berkata, saya tidak bisa menempelkan kekosongan.`")
        return
...
CMD_HELP.update(
    {
        ...
        \n\n.getpaste\
        \nPenggunaan: Mendapat konten paste atau url yang dipersingkat dari dogbin (https://del.dog/)\
        \n\n.neko <teks/balas>\
