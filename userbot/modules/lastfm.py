...
CMD_HELP.update(
    {
        "lastfm": ".lastfm\
    \nPenggunaan: Menampilkan trek scrobbling saat ini atau scrobbles terbaru jika tidak ada yang diputar.\
    \n\nlastbio: .lastbio <on/off>\
    \nPenggunaan: Mengaktifkan/Menonaktifkan pemutaran last.fm saat ini ke bio.\
    \n\nlastlog: .lastlog <on/off>\
    \nPenggunaan: Aktifkan/Nonaktifkan log bio last.fm di grup bot-log."
    }
)
