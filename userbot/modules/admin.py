...
async def kick(usr):
    ...
    if not user:
        await usr.edit("`Tidak dapat mengambil pengguna.`")
        return
...
async def get_users(show):
    ...
    try:
        ...
        await show.edit("Hmmmm, ini grup yang sangat besar. Menampilkan daftar anggota dengan file.")
...
async def get_usersdel(show):
    ...
    try:
        ...
        await show.edit(
            "Hmmmm, ini grup yang sangat besar. Menampilkan daftar anggota yang akun terhapus dengan file."
        )
...
CMD_HELP.update(
    {
        "admin": ".promote <username/balas pesannya> <custom rank (optional)>\
\nUsage: Memberikan hak admin kepada orang dalam grup.\
\n\n.demote <username/balas pesannya>\
\nUsage: Mencabut izin admin orang tersebut dalam grup.\
\n\n.ban <username/reply> <alasan (optional)>\
\nUsage: Ban seseorang dari grup.\
\n\n.unban <username/balas pesannya>\
\nUsage: Menghapus Ban dari orang dalam grup.\
\n\n.mute <username/balas pesannya> <alasan (optional)>\
\nUsage: Memute orang dalam grub, juga berfungsi pada admin.\
\n\n.unmute <username/balas pesannya>\
\nUsage: Menghapus seseorang dalam daftar mute.\
\n\n.gmute <username/balas pesannya> <Alasan (optional)>\
\nUsage: Memute orang di semua grup yang memiliki kesamaan dengan Anda dan dia.\
\n\n.ungmute <username/balas pesannya>\
\nUsage: Balas pesan seseorang dengan .ungmute untuk menghapusnya dari daftar yang dimute.\
\n\n.zombies\
\nUsage: Mencari akun yang dihapus dalam grup, Gunakan .zombies clean untuk menghapus akun yang dihapus dari grup.\
\n\n.all\
\nUsage: Tag semua anggota di grup.\
\n\n.admins\
\nUsage: Mengambil daftar admin di grup.\
\n\n.bots\
\nUsage: Mengambil daftar bot di obrolan.\
\n\n.users or .users <nama anggota>\
\nUsage: Menampilkan anggota di grup.\
\n\n.setgppic <balas gambarnya>\
\nUsage: Mengganti atau memasang logo grup."
    }
)
