...
async def gethash(hash_q):
    ...
    if len(ans) > 4096:
        ...
        await hash_q.client.send_file(
            ...
            "hashes.txt",
            reply_to=hash_q.id,
            caption="`Ini terlalu besar, sebagai gantinya saya mengirim file teks. `",
        )
...
CMD_HELP.update({"base64": "Temukan pengkodean base64 dari string yang diberikan"})

CMD_HELP.update(
    {
        "hash": "Temukan md5, sha1, sha256, sha512 dari string tersebut saat ditulis ke dalam file txt."
    }
)
