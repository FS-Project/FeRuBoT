...
async def download(target_file):
    ...
    await target_file.edit("Prosesss...")
...
async def uploadir(udir_event):
    ...
    if os.path.exists(input_str):
        await udir_event.edit("Prosesss...")
        lst_of_files = []
        ...
        for single_file in lst_of_files:
            if os.path.exists(single_file):
                ...
                uploaded = uploaded + 1
        await udir_event.edit("Berhasil mengunggah {} file !!".format(uploaded))
    else:
        await udir_event.edit("404: Directory Tidak Ditemukan")


@register(pattern=r".upload (.*)", outgoing=True)
async def upload(u_event):
    """ For .upload command, allows you to upload a file from the userbot's server """
    await u_event.edit("Prosesss...")
    ...
    if os.path.exists(input_str):
        ...
        await u_event.edit("Berhasil diupload !!")
    else:
    ...
    if os.path.exists(file_name):
        ...
        try:
            if supports_streaming:
                ...
                return await uas_event.edit("TBD: Belum (yet) Diimplementasikan")
            os.remove(thumb)
            await uas_event.edit("Berhasil diupload !!")
        except FileNotFoundError as err:
            await uas_event.edit(str(err))
    else:
        await uas_event.edit("404: File Tidak Ditemukan")


CMD_HELP.update(
    {
        "download": ".download <link|namafile> atau balas media\
