...
async def info(event):
    await event.edit("`Menganalisis pesan...`")
    ...
    try:
        ...
        print("Exception:", e)
        await event.edit("`kesalahan tak terduga telah muncul.`")
    return
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`channel/group tidak valid`")
            return None
        except ChannelPrivateError:
            await event.edit(
                "`Ini adalah channel / grup pribadi atau saya dibanned dari sana`"
            )
            return None
        except ChannelPublicGroupNaError:
            await event.edit("`Channel atau supergroup tidak ada`")
            return None
...
CMD_HELP.update(
    {
        "chatinfo": ".chatinfo [optional: <balas / tag / id obrolan / tautan undangan]\
